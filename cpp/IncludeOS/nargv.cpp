...
NARGV *nargv_parse(const char *input) {
    ...
    NARGV *nvp = static_cast<NARGV*>(calloc(1, sizeof(NARGV)));
    ...
    nvp->argv = static_cast<char**>(calloc(nvp->argc + 1, sizeof(char *)));
    nvp->data = static_cast<char*>(calloc(nvp->data_length, 1));
